...
class PPGPR(gpytorch.models.ApproximateGP):
    def __init__(self,
            kernel='rbf',
            data=None,
            dtype=torch.float64,
        ...
        # Cholesky variational distribution defaults to float32 type
        ...
        super(PPGPR, self).__init__(variational_strategy)
        ...
        self.loss_f = gpytorch.mlls.PredictiveLogLikelihood
